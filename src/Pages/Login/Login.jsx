        ...
        <div className="flex flex-col lg:justify-between gap-28 items-center lg:flex-row">
          <div className="flex flex-col gap-[50px] ">
            ...
            <div className="flex flex-col gap-[20px]">
              <button className="w-[250px] lg:w-[500px] md:w-[420px] h-[60px] bg-[#FF8A00] rounded-[10px] text-[14px] text-[#fff] font-primary font-[400] hover:transition-all hover:opacity-75 duration-200">
                Log in
              </button>
